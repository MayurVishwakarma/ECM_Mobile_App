  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://wmsservices.seprojects.in/api/infoReport/GetInformationStatusCount?AreaId=$area&DistributoryId=$distibutory&Source=oms&InfoTypeName=information&conString=$conString'));
