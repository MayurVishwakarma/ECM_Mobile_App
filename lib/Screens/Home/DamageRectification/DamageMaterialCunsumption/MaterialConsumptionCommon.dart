...
class MaterialConsumption_Screen extends StatefulWidget {
  @override
  _MaterialConsumption_ScreenState createState() =>
      _MaterialConsumption_ScreenState();
}

class _MaterialConsumption_ScreenState
    extends State<MaterialConsumption_Screen> {
  int pageIndex = 0;
  ...
  Widget build(BuildContext context) {
    final pages = [
      if (dcString![0] == '1')
        Oms_MaterialConsumption(ProjectName: projectName, Source: sourceoms),
      if (dcString![1] == '1')
        Ams_MaterialConsumption(ProjectName: projectName, Source: sourceams),
      if (dcString![2] == '1')
        Rms_MaterialConsumption(ProjectName: projectName, Source: sourcerms),
      if (dcString![3] == '1')
        Lora_MaterialConsumption(ProjectName: projectName, Source: sourcelora),
    ];
