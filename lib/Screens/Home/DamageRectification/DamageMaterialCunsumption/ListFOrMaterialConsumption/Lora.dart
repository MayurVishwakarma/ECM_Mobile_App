                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              ///Mechanical
                              if (_DisplayList!.first.mechanical! != 0)
                                Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: InkWell(
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://wmsservices.seprojects.in/api/Rectify/RectifyCount?areaId=all&DistributoryId=all&source=lora&conString=$conString'));
