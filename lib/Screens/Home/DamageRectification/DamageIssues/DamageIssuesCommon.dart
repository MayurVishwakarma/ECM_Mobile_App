...
import 'package:ecm_application/Screens/Home/DamageRectification/DamageIssues/IssuesList/AmsIssues.dart';
import 'package:ecm_application/Screens/Home/DamageRectification/DamageIssues/IssuesList/LoraIssues.dart';
import 'package:ecm_application/Screens/Home/DamageRectification/DamageIssues/IssuesList/OmsIssues.dart';
...
class DamageIssues_Screen extends StatefulWidget {
  @override
  _DamageIssues_ScreenState createState() => _DamageIssues_ScreenState();
}

class _DamageIssues_ScreenState extends State<DamageIssues_Screen> {
  int pageIndex = 0;
  ...
  Widget build(BuildContext context) {
    final pages = [
      if (dcString![0] == '1')
        Oms_Issues(ProjectName: projectName, Source: source),
      if (dcString![1] == '1')
        Ams_issues(ProjectName: projectName, Source: source),
      if (dcString![2] == '1')
        Rms_MaterialConsumption(ProjectName: projectName, Source: source),
      if (dcString![3] == '1')
        Lora_issues(ProjectName: projectName, Source: source),
    ];

    return Scaffold(
        backgroundColor: Colors.white,
        appBar: AppBar(
          title: Text('Issues Counter Report'),
        ),
